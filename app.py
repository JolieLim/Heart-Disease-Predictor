...
def show_user_form():
    ...
    smoking = st.selectbox("Have you smoked cigarettes?", ['No', 'Yes'])
...
if st.button("💡 Predict"):
    ...
    if prob >= 0.3:
        st.error(f"🚨 Very High Risk: Likely to have heart disease.\nProbability: {prob:.2%}")
    elif prob >= 0.1:
        st.warning(f"⚠️ Moderate Risk: Some risk of heart disease.\nProbability: {prob:.2%}")
    else:
